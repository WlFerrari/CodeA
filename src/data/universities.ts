...
export const universities: University[] = [
  ...
  { name: 'Faculdade Educacional de Cornélio Procópio (FECP)', domain: 'fecp.edu.br' },
  { name: 'Instituto Federal do Paraná (IFPR) - Campus Londrina', domain: 'ifpr.edu.br' },
  { name: 'Faculdade de Tecnologia de Londrina (FATEC)', domain: 'fateclondrina.edu.br' }
];